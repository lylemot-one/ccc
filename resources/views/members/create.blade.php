    ...
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('members.store') }}" method="POST"> @csrf
                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="shadow overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    @livewire('dropdowns', ['t1'=>old('coop_TypeL1', ""), 't2'=>old('coop_TypeL2', "")])
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="emp_Info" class="mt-10 sm:mt-0 @if(old('coop_TypeL1')!='1000') hidden @endif">
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            ...
                                            <input type="text" name="emp_ID" id="emp_ID" value="{{ old('emp_ID') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('emp_ID')) border border-red-500 @endif"> 
                                        </div>
                                        <!-- <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="emp_Status" class="block text-sm font-medium text-gray-700">Employee Status *</label>
                                            <input type="text" name="emp_Status" id="emp_Status" value="{{ old('emp_Status') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('emp_Status')) border border-red-500 @endif"> 
                                        </div> -->
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="emp_Dept" class="block text-sm font-medium text-gray-700">Department/Agency *</label>
                                            <input type="text" name="emp_Dept" id="emp_Dept" value="{{ old('emp_Dept') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('emp_Dept')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="emp_Pos" class="block text-sm font-medium text-gray-700">Designation *</label>
                                            <input type="text" name="emp_Pos" id="emp_Pos" value="{{ old('emp_Pos') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('emp_Pos')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="emp_TelWork" class="block text-sm font-medium text-gray-700">Office Phone No. *</label>
                                            <input type="number" name="emp_TelWork" id="emp_TelWork" value="{{ old('emp_TelWork') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('emp_TelWork')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="emp_TIN" class="block text-sm font-medium text-gray-700">TIN ID No. *</label>
                                            <input type="number" name="emp_TIN" id="emp_TIN" value="{{ old('emp_TIN') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('emp_TIN')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="emp_GSIS" class="block text-sm font-medium text-gray-700">GSIS ID No. *</label>
                                            <input type="number" name="emp_GSIS" id="emp_GSIS" value="{{ old('emp_GSIS') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('emp_GSIS')) border border-red-500 @endif"> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            ...
                                            <input type="text" name="info_LName" id="info_LName" value="{{ old('info_LName') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('info_LName')) border border-red-500 @endif"> 
                                            <input type="hidden" id="created_by" name="created_by" value="{{ Auth::user()->id }}">
                                        </div>
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            <label for="info_FName" class="block text-sm font-medium text-gray-700">Given Name *</label>
                                            <input type="text" name="info_FName" id="info_FName" value="{{ old('info_FName') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('info_FName')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input type="text" name="info_Address" id="info_Address" value="{{ old('info_Address') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="info_BDay" class="block text-sm font-medium text-gray-700">Date of Birth *</label>
                                            <input type="date" name="info_BDay" id="info_BDay" value="{{ old('info_BDay') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('info_BDay')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="info_BPlace" class="block text-sm font-medium text-gray-700">Birth Place *</label>
                                            <input type="text" name="info_BPlace" id="info_BPlace" value="{{ old('info_BPlace') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('info_BPlace')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="info_Citizen" class="block text-sm font-medium text-gray-700">Citizenship *</label>
                                            <input type="text" name="info_Citizen" id="info_Citizen" value="{{ old('info_Citizen') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('info_Citizen')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-3">
                                            ...
                                            <select id="info_CStatus" name="info_CStatus" value="{{ old('info_CStatus') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                <option value="Single" {{ old('info_CStatus') == 'Single' ? 'selected':'' }}>Single</option>
                                                <option value="Married" {{ old('info_CStatus') == 'Married' ? 'selected':'' }}>Married</option>
                                                <option value="Widowed" {{ old('info_CStatus') == 'Widowed' ? 'selected':'' }}>Widowed</option>
                                            </select>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-3">
                                            ...
                                            <select name="info_Gender" id="info_Gender" value="{{ old('info_Gender') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                <option value="M" {{ old('info_Gender') == 'M' ? 'selected':'' }}>Male</option>
                                                <option value="F" {{ old('info_Gender') == 'F' ? 'selected':'' }}>Female</option>
                                            </select>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="info_MthIncome" class="block text-sm font-medium text-gray-700">Monthly Income *</label>
                                            <input type="text" name="info_MthIncome" id="info_MthIncome" value="{{ old('info_MthIncome') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('info_MthIncome')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="info_Income" class="block text-sm font-medium text-gray-700">Source of Income *</label>
                                            <input type="text" name="info_Income" id="info_Income" value="{{ old('info_Income') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('info_Income')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="info_Education" class="block text-sm font-medium text-gray-700">Educational Attainment *</label>
                                            <select name="info_Education" id="info_Education" value="{{ old('info_Education') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                <option value="Elementary School" {{ old('info_Education') == 'Elementary School' ? 'selected':'' }}>Elementary School</option>
                                                <option value="High School" {{ old('info_Education') == 'High School' ? 'selected':'' }}>High School</option>
                                                <option value="Bachelors Degree" {{ old('info_Education') == 'Bachelors Degree' ? 'selected':'' }}>Bachelor's Degree</option>
                                                <option value="Vocational" {{ old('info_Education') == 'Vocational' ? 'selected':'' }}>Vocational</option>
                                            </select>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            ...
                                            <input type="text" name="info_Cell" id="info_Cell" value="{{ old('info_Cell') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('info_Cell')) border border-red-500 @endif"> 
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                        ...
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            ...
                                            <input type="text" name="info_EAdd" id="info_EAdd" value="{{ old('info_EAdd') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('info_EAdd')) border border-red-500 @endif"> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="relative overflow-x-auto sm:rounded-lg">
                                                <table class="w-full text-sm font-medium text-gray-700">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text" name="info_D3Name" id="info_D3Name" value="{{ old('info_D3Name') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                                            </td>
                                                            <td class="px-6">
                                                                <input type="date" name="info_D3Bday" id="info_D3Bday" value="{{ old('info_D3Bday') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                                            </td>
                                                            <td>
                                                                <input type="text" name="info_D3Rel" id="info_D3Rel" value="{{ old('info_D3Rel') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="text" name="info_D4Name" id="info_D4Name" value="{{ old('info_D4Name') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                                            </td>
                                                            <td class="px-6">
                                                                <input type="date" name="info_D4Bday" id="info_D4Bday" value="{{ old('info_D4Bday') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                                            </td>
                                                            <td>
                                                                <input type="text" name="info_D4Rel" id="info_D4Rel" value="{{ old('info_D4Rel') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="text" name="info_D5Name" id="info_D5Name" value="{{ old('info_D5Name') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                                            </td>
                                                            <td class="px-6">
                                                                <input type="date" name="info_D5Bday" id="info_D5Bday" value="{{ old('info_D5Bday') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                                            </td>
                                                            <td>
                                                                <input type="text" name="info_D5Rel" id="info_D5Rel" value="{{ old('info_D5Rel') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
